...
#define CAN_TX5_FUNC_ENABLE            (1u)
#define CAN_TX6_FUNC_ENABLE            (1u)
#define CAN_TX7_FUNC_ENABLE            (1u)
...
#define CAN_TX_MAILBOX_TYPE            (0xFFu)
...
/* General */
#define CAN_BITRATE                   (3u)
#define CAN_CFG_REG_TSEG1             (7u - 1u)
