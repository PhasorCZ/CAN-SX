...
#define ADC_SAR_Seq_DEFAULT_VREF_MV_VALUE          (2500)
#define ADC_SAR_Seq_DEFAULT_BUFFER_GAIN            (0u)
#define ADC_SAR_Seq_DEFAULT_AVG_SAMPLES_NUM        (6u)
#define ADC_SAR_Seq_DEFAULT_AVG_SAMPLES_DIV        (6u < 4u) ? (int16)(0x100u >> (7u - 6u)) : (int16)(0x100u >> 4u)
...
#define ADC_SAR_Seq_DEFAULT_COMPARE_MODE           (2u)
...
#define ADC_SAR_Seq_TOTAL_CHANNELS_NUM             (7u)
#define ADC_SAR_Seq_SEQUENCED_CHANNELS_NUM         (6u)
#define ADC_SAR_Seq_DEFAULT_EN_CHANNELS            (63u)
#define ADC_SAR_Seq_NOMINAL_CLOCK_FREQ             (3428571)
#define ADC_SAR_Seq_INJ_CHANNEL_ENABLED            (1u)
