...
static void ClockSetup(void)
{
	...
	CY_SET_REG32(CYREG_EXCO_PLL_CONFIG, 0x80020710u);
	CyDelayCycles(240u);
	CY_SET_REG32(CYREG_EXCO_PLL_CONFIG, 0xC0020710u);
	...
	if ((0UL == (CY_SYS_CLK_ECO_CONFIG_REG & CY_SYS_CLK_ECO_CONFIG_ENABLE)) ||
	    (0UL != (CY_SYS_CLK_ECO_STATUS_REG & CY_SYS_CLK_ECO_STATUS_WATCHDOG_ERROR)))
	{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x00000D00u);
	...
	CyIntEnable(13u);
	CY_SET_REG32((void *)(CYREG_WCO_WDT_CONFIG), 0x14010000u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x004300AAu);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x004300AAu);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL2), 0x00000808u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x0000EE00u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL4), 0x0000FFFFu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x000004B6u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_INTR_CFG), 0x000000A0u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC2), 0x000000E0u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC), 0x00D89D8Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC2), 0x0000000Du);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT6_INTR_CFG), 0x00000200u);
