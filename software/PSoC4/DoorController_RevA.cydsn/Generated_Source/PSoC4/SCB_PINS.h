...
/* Unconfigured pins */
#define SCB_REMOVE_RX_WAKE_SCL_MOSI_PIN  (1u)
#define SCB_REMOVE_RX_SCL_MOSI_PIN      (1u)
#define SCB_REMOVE_TX_SDA_MISO_PIN      (1u)
...
#define SCB_REMOVE_SPI_MASTER_SS0_PIN      (0u)
...
/* Unconfigured pins */
#define SCB_RX_WAKE_SCL_MOSI_PIN (0u == SCB_REMOVE_RX_WAKE_SCL_MOSI_PIN)
#define SCB_RX_SCL_MOSI_PIN     (0u == SCB_REMOVE_RX_SCL_MOSI_PIN)
#define SCB_TX_SDA_MISO_PIN     (0u == SCB_REMOVE_TX_SDA_MISO_PIN)
...
#if (SCB_RX_WAKE_SCL_MOSI_PIN)
    #include "SCB_uart_rx_wake_i2c_scl_spi_mosi.h"
#endif /* (SCB_RX_SCL_MOSI) */

#if (SCB_RX_SCL_MOSI_PIN)
    #include "SCB_uart_rx_i2c_scl_spi_mosi.h"
#endif /* (SCB_RX_SCL_MOSI) */

#if (SCB_TX_SDA_MISO_PIN)
    #include "SCB_uart_tx_i2c_sda_spi_miso.h"
#endif /* (SCB_TX_SDA_MISO) */
...
#if (SCB_RX_SCL_MOSI_PIN)
    #define SCB_RX_SCL_MOSI_HSIOM_REG   (*(reg32 *) SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define SCB_RX_SCL_MOSI_HSIOM_PTR   ( (reg32 *) SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    
    #define SCB_RX_SCL_MOSI_HSIOM_MASK      (SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SCB_RX_SCL_MOSI_HSIOM_POS       (SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define SCB_RX_SCL_MOSI_HSIOM_SEL_GPIO  (SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define SCB_RX_SCL_MOSI_HSIOM_SEL_I2C   (SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define SCB_RX_SCL_MOSI_HSIOM_SEL_SPI   (SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define SCB_RX_SCL_MOSI_HSIOM_SEL_UART  (SCB_uart_rx_i2c_scl_spi_mosi__0__HSIOM_UART)
    
#elif (SCB_RX_WAKE_SCL_MOSI_PIN)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_REG   (*(reg32 *) SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_PTR   ( (reg32 *) SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_MASK      (SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_POS       (SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_SEL_GPIO  (SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C   (SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI   (SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define SCB_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART  (SCB_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_UART)    
   
    #define SCB_RX_WAKE_SCL_MOSI_INTCFG_REG (*(reg32 *) SCB_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SCB_RX_WAKE_SCL_MOSI_INTCFG_PTR ( (reg32 *) SCB_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SCB_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (SCB_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define SCB_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK ((uint32) SCB_INTCFG_TYPE_MASK << \
                                                                           SCB_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins SCB_RX_SCL_MOSI_PIN or SCB_RX_WAKE_SCL_MOSI_PIN present.*/
#endif /* (SCB_RX_SCL_MOSI_PIN) */

#if (SCB_TX_SDA_MISO_PIN)
    #define SCB_TX_SDA_MISO_HSIOM_REG   (*(reg32 *) SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define SCB_TX_SDA_MISO_HSIOM_PTR   ( (reg32 *) SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    
    #define SCB_TX_SDA_MISO_HSIOM_MASK      (SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM_MASK)
    #define SCB_TX_SDA_MISO_HSIOM_POS       (SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM_SHIFT)
    #define SCB_TX_SDA_MISO_HSIOM_SEL_GPIO  (SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM_GPIO)
    #define SCB_TX_SDA_MISO_HSIOM_SEL_I2C   (SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM_I2C)
    #define SCB_TX_SDA_MISO_HSIOM_SEL_SPI   (SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM_SPI)
    #define SCB_TX_SDA_MISO_HSIOM_SEL_UART  (SCB_uart_tx_i2c_sda_spi_miso__0__HSIOM_UART)
#endif /* (SCB_TX_SDA_MISO_PIN) */
...
/* Pins settings index. */
#define SCB_RX_WAKE_SCL_MOSI_PIN_INDEX   (0u)
#define SCB_RX_SCL_MOSI_PIN_INDEX       (0u)
#define SCB_TX_SDA_MISO_PIN_INDEX       (1u)
...
/* Pins settings mask. */
#define SCB_RX_WAKE_SCL_MOSI_PIN_MASK ((uint32) 0x01u << SCB_RX_WAKE_SCL_MOSI_PIN_INDEX)
#define SCB_RX_SCL_MOSI_PIN_MASK     ((uint32) 0x01u << SCB_RX_SCL_MOSI_PIN_INDEX)
#define SCB_TX_SDA_MISO_PIN_MASK     ((uint32) 0x01u << SCB_TX_SDA_MISO_PIN_INDEX)
...
#if (SCB_TX_SDA_MISO_PIN)
    #define SCB_CHECK_TX_SDA_MISO_PIN_USED \
                (SCB_PIN_DM_ALG_HIZ != \
                    SCB_GET_P4_PIN_DM(SCB_uart_tx_i2c_sda_spi_miso_PC, \
                                                   SCB_uart_tx_i2c_sda_spi_miso_SHIFT))
#endif /* (SCB_TX_SDA_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define SCB_SET_I2C_SCL_DR(val) \
                            SCB_uart_rx_wake_i2c_scl_spi_mosi_Write(val)

    #define SCB_SET_I2C_SCL_HSIOM_SEL(sel) \
                    SCB_SET_HSIOM_SEL(SCB_RX_WAKE_SCL_MOSI_HSIOM_REG,  \
                                                   SCB_RX_WAKE_SCL_MOSI_HSIOM_MASK, \
                                                   SCB_RX_WAKE_SCL_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define SCB_WAIT_SCL_SET_HIGH  (0u == SCB_uart_rx_wake_i2c_scl_spi_mosi_Read())

#elif (SCB_RX_SCL_MOSI_PIN)
    #define SCB_SET_I2C_SCL_DR(val) \
                            SCB_uart_rx_i2c_scl_spi_mosi_Write(val)


    #define SCB_SET_I2C_SCL_HSIOM_SEL(sel) \
                            SCB_SET_HSIOM_SEL(SCB_RX_SCL_MOSI_HSIOM_REG,  \
                                                           SCB_RX_SCL_MOSI_HSIOM_MASK, \
                                                           SCB_RX_SCL_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define SCB_WAIT_SCL_SET_HIGH  (0u == SCB_uart_rx_i2c_scl_spi_mosi_Read())
...
#elif (SCB_TX_SDA_MISO_PIN)
    #define SCB_WAIT_SDA_SET_HIGH  (0u == SCB_uart_tx_i2c_sda_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define SCB_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) SCB_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define SCB_REMOVE_MOSI_SCL_RX_WAKE_PIN    SCB_REMOVE_RX_WAKE_SCL_MOSI_PIN
#define SCB_REMOVE_MOSI_SCL_RX_PIN         SCB_REMOVE_RX_SCL_MOSI_PIN
#define SCB_REMOVE_MISO_SDA_TX_PIN         SCB_REMOVE_TX_SDA_MISO_PIN
...
/* Unconfigured pins */
#define SCB_MOSI_SCL_RX_WAKE_PIN   SCB_RX_WAKE_SCL_MOSI_PIN
#define SCB_MOSI_SCL_RX_PIN        SCB_RX_SCL_MOSI_PIN
#define SCB_MISO_SDA_TX_PIN        SCB_TX_SDA_MISO_PIN
#ifndef SCB_SCLK_PIN
...
#define SCB_SS0_PIN                SCB_RTS_SS0_PIN
    ...
    #define SCB_MOSI_SCL_RX_WAKE_HSIOM_REG     SCB_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_MOSI_SCL_RX_WAKE_HSIOM_PTR     SCB_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_MOSI_SCL_RX_WAKE_HSIOM_MASK    SCB_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_MOSI_SCL_RX_WAKE_HSIOM_POS     SCB_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define SCB_MOSI_SCL_RX_WAKE_INTCFG_REG    SCB_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_MOSI_SCL_RX_WAKE_INTCFG_PTR    SCB_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define SCB_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   SCB_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define SCB_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  SCB_RX_WAKE_SCL_MOSI_HSIOM_REG
#endif /* (SCB_RX_WAKE_SCL_MOSI_PIN) */

#if (SCB_MOSI_SCL_RX_PIN)
    #define SCB_MOSI_SCL_RX_HSIOM_REG      SCB_RX_SCL_MOSI_HSIOM_REG
    #define SCB_MOSI_SCL_RX_HSIOM_PTR      SCB_RX_SCL_MOSI_HSIOM_PTR
    #define SCB_MOSI_SCL_RX_HSIOM_MASK     SCB_RX_SCL_MOSI_HSIOM_MASK
    #define SCB_MOSI_SCL_RX_HSIOM_POS      SCB_RX_SCL_MOSI_HSIOM_POS
#endif /* (SCB_MOSI_SCL_RX_PIN) */

#if (SCB_MISO_SDA_TX_PIN)
    #define SCB_MISO_SDA_TX_HSIOM_REG      SCB_TX_SDA_MISO_HSIOM_REG
    #define SCB_MISO_SDA_TX_HSIOM_PTR      SCB_TX_SDA_MISO_HSIOM_REG
    #define SCB_MISO_SDA_TX_HSIOM_MASK     SCB_TX_SDA_MISO_HSIOM_REG
    #define SCB_MISO_SDA_TX_HSIOM_POS      SCB_TX_SDA_MISO_HSIOM_REG
...
#define SCB_MOSI_SCL_RX_WAKE_PIN_INDEX SCB_RX_WAKE_SCL_MOSI_PIN_INDEX
#define SCB_MOSI_SCL_RX_PIN_INDEX      SCB_RX_SCL_MOSI_PIN_INDEX
#define SCB_MISO_SDA_TX_PIN_INDEX      SCB_TX_SDA_MISO_PIN_INDEX
...
#define SCB_MOSI_SCL_RX_WAKE_PIN_MASK SCB_RX_WAKE_SCL_MOSI_PIN_MASK
#define SCB_MOSI_SCL_RX_PIN_MASK      SCB_RX_SCL_MOSI_PIN_MASK
#define SCB_MISO_SDA_TX_PIN_MASK      SCB_TX_SDA_MISO_PIN_MASK
