...
*/
#define SmartIO_CHANNEL_NONE    0x00UL /**< Do not bypass any channels */
#define SmartIO_CHANNEL0        0x01UL /**< Channel 0 (data0 <-> gpio0) */
#define SmartIO_CHANNEL1        0x02UL /**< Channel 1 (data1 <-> gpio1) */
#define SmartIO_CHANNEL2        0x04UL /**< Channel 2 (data2 <-> gpio2) */
#define SmartIO_CHANNEL3        0x08UL /**< Channel 3 (data3 <-> gpio3) */
#define SmartIO_CHANNEL4        0x10UL /**< Channel 4 (data4 <-> gpio4) */
#define SmartIO_CHANNEL5        0x20UL /**< Channel 5 (data5 <-> gpio5) */
#define SmartIO_CHANNEL6        0x40UL /**< Channel 6 (data6 <-> gpio6) */
#define SmartIO_CHANNEL7        0x80UL /**< Channel 7 (data7 <-> gpio7) */
#define SmartIO_CHANNEL_ALL     0xffUL /**< Bypass all channels */
/** \} */
...
*/
#define SmartIO_CLK_GPIO0       0UL  /**< Clock sourced from signal on gpio0 */
#define SmartIO_CLK_GPIO1       1UL  /**< Clock sourced from signal on gpio1 */
#define SmartIO_CLK_GPIO2       2UL  /**< Clock sourced from signal on gpio2 */
#define SmartIO_CLK_GPIO3       3UL  /**< Clock sourced from signal on gpio3 */
#define SmartIO_CLK_GPIO4       4UL  /**< Clock sourced from signal on gpio4 */
#define SmartIO_CLK_GPIO5       5UL  /**< Clock sourced from signal on gpio5 */
#define SmartIO_CLK_GPIO6       6UL  /**< Clock sourced from signal on gpio6 */
#define SmartIO_CLK_GPIO7       7UL  /**< Clock sourced from signal on gpio7 */
#define SmartIO_CLK_DATA0       8UL  /**< Clock sourced from signal on data0 */
#define SmartIO_CLK_DATA1       9UL  /**< Clock sourced from signal on data1 */
#define SmartIO_CLK_DATA2       10UL /**< Clock sourced from signal on data2 */
#define SmartIO_CLK_DATA3       11UL /**< Clock sourced from signal on data3 */
#define SmartIO_CLK_DATA4       12UL /**< Clock sourced from signal on data4 */
#define SmartIO_CLK_DATA5       13UL /**< Clock sourced from signal on data5 */
#define SmartIO_CLK_DATA6       14UL /**< Clock sourced from signal on data6 */
#define SmartIO_CLK_DATA7       15UL /**< Clock sourced from signal on data7 */
#define SmartIO_DIV_CLK_ACT     16UL /**< Clock sourced from a divided clock (Active) */
#define SmartIO_DIV_CLK_DS      17UL /**< Clock sourced from a divided clock (Deep-Sleep) */
#define SmartIO_DIV_CLK_HIB     18UL /**< Clock sourced from a divided clock (Hibernate) */
#define SmartIO_LFCLK           19UL /**< Clock sourced from LFCLK */
#define SmartIO_CLK_GATED       20UL /**< Disables the clock connection. Used when turning off the block */
#define SmartIO_ASYNC           31UL /**< Asynchronous operation */
/** \} */
...
*/
#define SmartIO_OVCTRL_DISABLE  0UL /**< Controlled by HSIOM  */
#define SmartIO_OVCTRL_ENABLE   1UL /**< Controlled by SmartIO */
/** \} */
...
*/
#define SmartIO_TERM_NONE       0x00UL /**< No synchronization for all data/gpio */
#define SmartIO_TERM0           0x01UL /**< Enable synchronization for data0/gpio0 */
#define SmartIO_TERM1           0x02UL /**< Enable synchronization for data1/gpio1 */
#define SmartIO_TERM2           0x04UL /**< Enable synchronization for data2/gpio2 */
#define SmartIO_TERM3           0x08UL /**< Enable synchronization for data3/gpio3 */
#define SmartIO_TERM4           0x10UL /**< Enable synchronization for data4/gpio4 */
#define SmartIO_TERM5           0x20UL /**< Enable synchronization for data5/gpio5 */
#define SmartIO_TERM6           0x40UL /**< Enable synchronization for data6/gpio6 */
#define SmartIO_TERM7           0x80UL /**< Enable synchronization for data7/gpio7 */
#define SmartIO_TERM_ALL        0xffUL /**< Enable sycnhronization for all data/gpio */
/** \} */

/** \defgroup lutNumConst Look-up table number constants
* \{
* Constants to be passed as "lutNum" parameter in 
* SmartIO_LUT_SelectInputs() and SmartIO_LUT_ConfigureMode() functions.
*/ 
#define SmartIO_LUT0            0UL /**< LUT number 0 */
#define SmartIO_LUT1            1UL /**< LUT number 1 */
#define SmartIO_LUT2            2UL /**< LUT number 2 */
#define SmartIO_LUT3            3UL /**< LUT number 3 */
#define SmartIO_LUT4            4UL /**< LUT number 4 */
#define SmartIO_LUT5            5UL /**< LUT number 5 */
#define SmartIO_LUT6            6UL /**< LUT number 6 */
#define SmartIO_LUT7            7UL /**< LUT number 7 */
/** \} */
...
*/
#define SmartIO_LUT_INPUT0      0x01UL /**< LUT input terminal 0 */
#define SmartIO_LUT_INPUT1      0x02UL /**< LUT input terminal 1 */
#define SmartIO_LUT_INPUT2      0x04UL /**< LUT input terminal 2 */
#define SmartIO_LUT_INPUT_ALL   0x07UL /**< All LUT input terminals */
/** \} */
...
*/ 
#define SmartIO_SRC_LUT0        0UL  /**< Source is LUT0 output */
#define SmartIO_SRC_LUT1        1UL  /**< Source is LUT1 output */
#define SmartIO_SRC_LUT2        2UL  /**< Source is LUT2 output */
#define SmartIO_SRC_LUT3        3UL  /**< Source is LUT3 output */
#define SmartIO_SRC_LUT4        4UL  /**< Source is LUT4 output */
#define SmartIO_SRC_LUT5        5UL  /**< Source is LUT5 output */
#define SmartIO_SRC_LUT6        6UL  /**< Source is LUT6 output */
#define SmartIO_SRC_LUT7        7UL  /**< Source is LUT7 output */
#define SmartIO_SRC_DATA_04     8UL  /**< Source is data0/data4 */
#define SmartIO_SRC_DATA_15     9UL  /**< Source is data1/data5 */
#define SmartIO_SRC_DATA_26     10UL /**< Source is data2/data6 */
#define SmartIO_SRC_DATA_37     11UL /**< Source is data3/data7 */
#define SmartIO_SRC_GPIO_04     12UL /**< Source is gpio0/gpio4 */
#define SmartIO_SRC_GPIO_15     13UL /**< Source is gpio1/gpio5 */
#define SmartIO_SRC_GPIO_26     14UL /**< Source is gpio2/gpio6 */
#define SmartIO_SRC_GPIO_37     15UL /**< Source is gpio3/gpio7 */
#define SmartIO_SRC_DU          16UL /**< Source is Data Unit output */
/** \} */
...
*/ 
#define SmartIO_MODE_COMB       0UL /**< Combinatorial mode */
#define SmartIO_MODE_REGIN      1UL /**< Registered input mode */
#define SmartIO_MODE_REGOUT     2UL /**< Registered output mode */
#define SmartIO_MODE_SRFF       3UL /**< S/R Flip-Flop mode */
/** \} */
...
*/
#define SmartIO_TR_CONST_ZERO   0UL /**< Constant 0 */
#define SmartIO_TR_CONST_ONE    1UL /**< Constant 1 */
#define SmartIO_TR_DU_OUT       2UL /**< Data unit output */
#define SmartIO_TR_LUT0         3UL /**< LUT 0 output */
#define SmartIO_TR_LUT1         4UL /**< LUT 1 output */
#define SmartIO_TR_LUT2         5UL /**< LUT 2 output */
#define SmartIO_TR_LUT3         6UL /**< LUT 3 output */
#define SmartIO_TR_LUT4         7UL /**< LUT 4 output */
#define SmartIO_TR_LUT5         8UL /**< LUT 5 output */
#define SmartIO_TR_LUT6         9UL /**< LUT 6 output */
#define SmartIO_TR_LUT7         10UL /**< LUT 7 output */
/** \} */
...
*/
#define SmartIO_DATA0             1UL /**< DU DATA0 register */
#define SmartIO_DATA1             2UL /**< DU DATA1 register */
#define SmartIO_DATA_BOTH         3UL /**< Both DU DATA0 and DATA1 registers */
/** \} */
...
*/ 
#define SmartIO_DATA_CONST_ZERO   0UL /**< Constant 0 */
#define SmartIO_DATA_TERM_DATA    1UL /**< Terminal data[7:0] */
#define SmartIO_DATA_TERM_GPIO    2UL /**< Terminal gpio[7:0] */
#define SmartIO_DATA_DU_REG       3UL /**< Data Unit register */
/** \} */

/** \defgroup duOpcConst Data Unit opcode constants
* \{
* Constants to be passed as "opCode" parameter in SmartIO_DU_OpCode() function.
*/
#define SmartIO_OPC_INCR           1UL /**< Count Up */
#define SmartIO_OPC_DECR           2UL /**< Count Down */
#define SmartIO_OPC_INCR_WRAP      3UL /**< Count Up and wrap */
#define SmartIO_OPC_DECR_WRAP      4UL /**< Count Down and wrap */
#define SmartIO_OPC_INCR_DECR      5UL /**< Count Up/Down */
#define SmartIO_OPC_INCR_DECR_WRAP 6UL /**< Count Up/Down and wrap */
#define SmartIO_OPC_ROR            7UL /**< Rotate right */
#define SmartIO_OPC_SHR            8UL /**< Shift right */
#define SmartIO_OPC_AND_OR         9UL /**< DU Data0 AND DU Data1 */
...
/* Global control */
#define SmartIO_BYPASS0         0UL
#define SmartIO_BYPASS1         0UL
...
/* LUT input selection */
#define SmartIO_LUT0_TR0        12UL
#define SmartIO_LUT0_TR1        13UL
#define SmartIO_LUT0_TR2        8UL
...
#define SmartIO_LUT4_TR0        12UL
#define SmartIO_LUT4_TR1        13UL
#define SmartIO_LUT4_TR2        8UL
...
#define SmartIO_REG_ZEROS                 (0x00000000UL)
#define SmartIO_REG_ONES                  (0xffffffffUL)

/* SmartIO Fabric Enable/Disable */
#define SmartIO_FABRIC_ENABLE             ((uint32)(0x01UL << CYFLD_PRGIO_PRT_ENABLED__OFFSET))
#define SmartIO_FABRIC_DISABLE            ((uint32)(~(uint32)(0x01UL << CYFLD_PRGIO_PRT_ENABLED__OFFSET)))
#define SmartIO_FABRIC_MASK               ((uint32)(0x01UL << CYFLD_PRGIO_PRT_ENABLED__OFFSET))

/* Bypass Mask */
#define SmartIO_BYPASS_MASK               ((uint32)(0xffUL << CYFLD_PRGIO_PRT_BYPASS__OFFSET))
#define SmartIO_BYPASS_CLEAR              ((uint32)(~(uint32)(0xffUL << CYFLD_PRGIO_PRT_BYPASS__OFFSET)))
...
#define SmartIO_CLOCK_CLEAR               ((uint32)(~(uint32)(0x1fUL << CYFLD_PRGIO_PRT_CLOCK_SRC__OFFSET)))
#define SmartIO_CLOCK_MASK                ((uint32)(0x1fUL << CYFLD_PRGIO_PRT_CLOCK_SRC__OFFSET))

/* Hold override HSIOM/SmartIO */
#define SmartIO_HLD_OVR_SMARTIO           ((uint32)(0x01UL << CYFLD_PRGIO_PRT_HLD_OVR__OFFSET))
#define SmartIO_HLD_OVR_HSIOM             ((uint32)(~(uint32)(0x01UL << CYFLD_PRGIO_PRT_HLD_OVR__OFFSET)))

/* Pipeline Enable/Disable */
#define SmartIO_PIPELINE_ENABLE           ((uint32)(0x01UL << CYFLD_PRGIO_PRT_PIPELINE_EN__OFFSET))
#define SmartIO_PIPELINE_DISABLE          ((uint32)(~(uint32)(0x01UL << CYFLD_PRGIO_PRT_PIPELINE_EN__OFFSET)))

/* Sync control clear */
#define SmartIO_IO_SYNC_MASK              ((uint32)(0xffUL << CYFLD_PRGIO_PRT_IO_SYNC_EN__OFFSET))
#define SmartIO_DATA_SYNC_MASK            ((uint32)(0xffUL << CYFLD_PRGIO_PRT_CHIP_SYNC_EN__OFFSET))
#define SmartIO_IO_SYNC_CLEAR             ((uint32)(~(uint32)(0xffUL << CYFLD_PRGIO_PRT_IO_SYNC_EN__OFFSET)))
#define SmartIO_DATA_SYNC_CLEAR           ((uint32)(~(uint32)(0xffUL << CYFLD_PRGIO_PRT_CHIP_SYNC_EN__OFFSET)))

/* LUT inputs clear */
#define SmartIO_LUT_TR0_CLEAR             ((uint32)(~(uint32)(0x0fUL << CYFLD_PRGIO_PRT_LUT_TR0_SEL__OFFSET)))
#define SmartIO_LUT_TR1_CLEAR             ((uint32)(~(uint32)(0x0fUL << CYFLD_PRGIO_PRT_LUT_TR1_SEL__OFFSET)))
#define SmartIO_LUT_TR2_CLEAR             ((uint32)(~(uint32)(0x0fUL << CYFLD_PRGIO_PRT_LUT_TR2_SEL__OFFSET)))
#define SmartIO_LUT_TR_CLEAR_ALL          (SmartIO_LUT_TR0_CLEAR & SmartIO_LUT_TR1_CLEAR & SmartIO_LUT_TR2_CLEAR)
#define SmartIO_LUT_TR0_MASK              ((uint32)(0x0fUL << CYFLD_PRGIO_PRT_LUT_TR0_SEL__OFFSET))
#define SmartIO_LUT_TR1_MASK              ((uint32)(0x0fUL << CYFLD_PRGIO_PRT_LUT_TR1_SEL__OFFSET))
#define SmartIO_LUT_TR2_MASK              ((uint32)(0x0fUL << CYFLD_PRGIO_PRT_LUT_TR2_SEL__OFFSET))

/* LUT config clear */
#define SmartIO_LUT_MAP_CLEAR             ((uint32)(~(uint32)(0xffUL << CYFLD_PRGIO_PRT_LUT__OFFSET)))
#define SmartIO_LUT_OPC_CLEAR             ((uint32)(~(uint32)(0x03UL << CYFLD_PRGIO_PRT_LUT_OPC__OFFSET)))
#define SmartIO_LUT_CTL_CLEAR             ((uint32)(SmartIO_LUT_MAP_CLEAR & SmartIO_LUT_OPC_CLEAR))
#define SmartIO_LUT_MAP_MASK              ((uint32)(0xffUL << CYFLD_PRGIO_PRT_LUT__OFFSET))
#define SmartIO_LUT_OPC_MASK              ((uint32)(0x03UL << CYFLD_PRGIO_PRT_LUT_OPC__OFFSET))

/* DU inputs clear */
#define SmartIO_DU_TR0_CLEAR              ((uint32)(~(uint32)(0x0fUL << CYFLD_PRGIO_PRT_DU_TR0_SEL__OFFSET)))
#define SmartIO_DU_TR1_CLEAR              ((uint32)(~(uint32)(0x0fUL << CYFLD_PRGIO_PRT_DU_TR1_SEL__OFFSET)))
#define SmartIO_DU_TR2_CLEAR              ((uint32)(~(uint32)(0x0fUL << CYFLD_PRGIO_PRT_DU_TR2_SEL__OFFSET)))
#define SmartIO_DU_TR_CLEAR_ALL           (SmartIO_DU_TR0_CLEAR & SmartIO_DU_TR1_CLEAR & SmartIO_DU_TR2_CLEAR)
#define SmartIO_DU_TR0_MASK               ((uint32)(0x0fUL << CYFLD_PRGIO_PRT_DU_TR0_SEL__OFFSET))
#define SmartIO_DU_TR1_MASK               ((uint32)(0x0fUL << CYFLD_PRGIO_PRT_DU_TR1_SEL__OFFSET))
#define SmartIO_DU_TR2_MASK               ((uint32)(0x0fUL << CYFLD_PRGIO_PRT_DU_TR2_SEL__OFFSET))

/* DU DATA0 and DATA1 clear */
#define SmartIO_DU_DATA0_CLEAR            ((uint32)(~(uint32)(0x03UL << CYFLD_PRGIO_PRT_DU_DATA0_SEL__OFFSET)))
#define SmartIO_DU_DATA1_CLEAR            ((uint32)(~(uint32)(0x03UL << CYFLD_PRGIO_PRT_DU_DATA1_SEL__OFFSET)))
#define SmartIO_DU_DATA01_CLEAR_BOTH      (SmartIO_DU_DATA0_CLEAR & SmartIO_DU_DATA1_CLEAR)
#define SmartIO_DU_DATA0_MASK             ((uint32)(0x03UL << CYFLD_PRGIO_PRT_DU_DATA0_SEL__OFFSET))
#define SmartIO_DU_DATA1_MASK             ((uint32)(0x03UL << CYFLD_PRGIO_PRT_DU_DATA1_SEL__OFFSET))
...
#define SmartIO_INIT_DU_TR0_SEL          ((uint32_t)(SmartIO_DU_TR0 << CYFLD_PRGIO_PRT_DU_TR0_SEL__OFFSET))
#define SmartIO_INIT_DU_TR1_SEL          ((uint32_t)(SmartIO_DU_TR1 << CYFLD_PRGIO_PRT_DU_TR1_SEL__OFFSET))
#define SmartIO_INIT_DU_TR2_SEL          ((uint32_t)(SmartIO_DU_TR2 << CYFLD_PRGIO_PRT_DU_TR2_SEL__OFFSET))
#define SmartIO_INIT_DU_DATA0_SEL        ((uint32_t)(SmartIO_DU_DATA0 << CYFLD_PRGIO_PRT_DU_DATA0_SEL__OFFSET))
#define SmartIO_INIT_DU_DATA1_SEL        ((uint32_t)(SmartIO_DU_DATA1 << CYFLD_PRGIO_PRT_DU_DATA1_SEL__OFFSET))
...
#define SmartIO_INIT_DU_SIZE             ((uint32_t)(SmartIO_DU_SIZE << CYFLD_PRGIO_PRT_DU_SIZE__OFFSET))
#define SmartIO_INIT_DU_OPC              ((uint32_t)(SmartIO_DU_OPCODE << CYFLD_PRGIO_PRT_DU_OPC__OFFSET))
